...
! function (a, b, c, d) {
    ...
    ! function (a, b, c, d) {
        ...
        e.Defaults = {
            ...
            var b = this.owl.options;
            b.thumbsPrerendered ? (this._thumbcontent._thumbcontainer = a("." + b.thumbContainerClass), b.movngnumbsInside && this._thumbcontent._thumbcontainer.appendTo(this.$element)) : this._thumbcontent._thumbcontainer = a("<div>").addClass(b.thumbContainerClass).appendTo(this.$element);
            var c;
            if (b.thumbImage)
