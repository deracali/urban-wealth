...
import DefaulterPayment from '../model/defaultersPayment.js';
...
const createPayment = async (req, res) => {
  ...
  try {
    ...
    const newPayment = new DefaulterPayment({
      amount,
      userId,
...
const getAllPayments = async (req, res) => {
  try {
    const payments = await DefaulterPayment.find();
...
const getPaymentById = async (req, res) => {
  ...
  try {
    const payment = await DefaulterPayment.findById(id);
    if (!payment) {
